...
export function Controls() {
  ...
  const {
    ...
    musicVolume, musicOffset, soundVolume, soundOffset,
    ...
    setMusicVolume, setMusicOffset, setSoundVolume, setSoundOffset,
          ...
          <Stack gap="md" mt="md">
            ...
            <div>
              <Group justify="space-between" mb={4}>
                ...
                <Text size="sm" c="dimmed" ff="monospace">{Math.round(soundVolume * 100)}%</Text>
              </Group>
              <Slider
                value={soundVolume}
